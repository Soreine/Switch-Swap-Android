...
import org.plume.soreine.framework.Image;
...
public class AndroidGraphics implements Graphics {
	...
	public Image newImage(String fileName, ImageFormat format) {
		// We get the preferred image format
		Config config = null;
		...
		// Retrieve the format that has been chosen by the BitmapFactory
		...
		// Return the newly created AndroidImage
